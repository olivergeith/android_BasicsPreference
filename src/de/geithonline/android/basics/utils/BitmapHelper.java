...
public class BitmapHelper {
     ...
     *            the filename
     */
    public static void saveBitmap2ExternalStorage(final Bitmap bitmap, final String directory, final String filename) {
    ...
    public static Bitmap tintImage(final Bitmap bitmap, final Paint paint, final int color) {
    ...
    public static Bitmap tintImage(final Bitmap bitmap, final int color) {
        final Paint paint = new Paint();
        paint.setColorFilter(new PorterDuffColorFilter(color, Mode.SRC_IN));
        final Bitmap bitmapResult = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Config.ARGB_8888);
        final Canvas canvas = new Canvas(bitmapResult);
