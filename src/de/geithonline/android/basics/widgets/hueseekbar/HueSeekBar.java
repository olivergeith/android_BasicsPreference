...
package de.geithonline.android.basics.widgets.hueseekbar;
...
public class HueSeekBar extends View {
    ...
    public HueSeekBar(final Context context) {
        super(context);
        init(context, null);
    }

    public HueSeekBar(final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HueSeekBar(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public HueSeekBar(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HueSeekBar);
    ...
    public void setVerticalAnimationListener(final VerticalAnimationListener verticalAnimationListener) {
    ...
    public void setCurrentHeight(final float currentHeight) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        final float positionProgress = width * currentProgress / maxProgress;
