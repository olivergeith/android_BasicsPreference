...
public class RangeSeekBar<T extends Number>extends ImageView {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        float barHeight;
        final int thumbNormal = R.drawable.seek_thumb_normal;
        final int thumbPressed = R.drawable.seek_thumb_pressed;
        final int thumbDisabled = R.drawable.seek_thumb_disabled;
